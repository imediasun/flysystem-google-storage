...
Discussion regarding bugs, new features, and implementation of existing features takes place in issues on the GitHub repo [here](https://github.com/Devmagellan/flysystem-google-storage/issues).
